    ...
    useEffect(() => {
        if (props.category === 0 && props.topic <= 13) {
            setCurriculumNumbers(
                curriculum_numbers_array[Number(props.category)][
                    Number(props.topic)
                ]
            );
            ...
            if (props.topic == 19) {
                setCurriculumNumbers(
                    curriculum_numbers_array[Number(props.category)][1]
                );
            } else {
                setCurriculumNumbers(
                    curriculum_numbers_array[Number(props.category)][0]
                );
            }
        } else {
