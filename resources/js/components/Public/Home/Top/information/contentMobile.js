...
const contentMobile = props => {
    ...
    if (
        typeof props.infos !== ("undefined" || "null") &&
        props.dates.length !== 0 &&
        props.dates.length === Object.keys(props.infos).length
    ) {
        list = (
                            ...
                            {props.infos[date].map((info, index) => (
                                ...
                                >
                                    <ListItemText
                                        ...
                                        sx={styleCursor}
                                        primary={
                                            info.information.length > 30
                                                ? info.information.substring(
                                                      0,
                                                      30
                                                  ) + "..."
                                                : info.information
        ...
        list = (
            <Typography sx={styleNonInfo}>お知らせはありません。</Typography>
        );
    }
