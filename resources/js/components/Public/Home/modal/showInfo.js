    ...
    return (
        <React.Fragment>
            ...
            <Box sx={{ width: "85%", m: '30px auto 0' }}>
                <Typography align="left" sx={{ fontSize: '16px', color: 'gray', mt: 2, wordBreak: 'break-word' }}>
                    { props.info.targets }
                </Typography>
                ...
                {is_admin == "staff" &&
                    <Typography align="right" variant="h6" sx={{ fontSize: '16px', wordBreak: 'break-word', color: 'gray', mt: 2 }}>
                        Slack通知：{ slack }
                    </Typography>
                }
            </Box>
