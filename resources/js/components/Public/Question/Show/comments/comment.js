    ...
    if (props.comment) {
        ...
        step1_fragments.map((fragment) => {
            ...
            if (fragment.indexOf('<image link=') !== -1) {
                ...
                comment.push(<a href={ image_url } data-lightbox="group"><img src={ image_url } height={200} width={200}/></a>);
                ...
                <Grid container spacing={2} justifyContent="left">
                    ...
                    <Grid item sx={{ marginTop: 4 }}>
                        <Typography
                            ...
                            component="div"
                        >
                            { props.is_staff ? "メンター" : "受講生" } &nbsp; { props.created_at }
                        </Typography>
                    </Grid>
                </Grid>
                
                { (props.user_id === props.target_student || props.is_admin === 'staff') && 
                    <Grid container justifyContent="right" alignItems="center" sx={{ marginTop: 1 }}>
                        <Grid item>
                            <Button
                                variant="text"
                                color="secondary"
