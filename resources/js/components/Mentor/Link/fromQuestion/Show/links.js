...
function Link(props) {
    ...
    const [default_unrelated_documents, setDefaultUnrelatedDocuments] = useState([]);
    ...
    const customList = (documents, upOrDown) => (
        ...
        >
            ...
            { props.staffs.map((staff) => {
                return (
                    <Accordion
                        expanded={ expanded === staff.id && upOrDown === whitchAccordion }
                                    ...
                                    if (document.user_id === staff.id) {
                                        return (
                                            ...
                                            >
                                                ...
                                                <ListItemText id={ labelId } primary={ document.title } />
                                            </ListItem>
                                        );
                                    }
                                })}
    ...
    return (
        <Box sx={{ marginTop: 4 }}>
            <Grid container spacing={2} justifyContent="center" alignItems="center">
                <Grid item sx={{ width: "100%" }}>{customList(related_documents, "up")}</Grid>
                    ...
                    <Grid container spacing={2} justifyContent="center" alignItems="center">
                            ...
                            <Grid container spacing={2} justifyContent="center" alignItems="center">
                                <Grid item>
                                    <Button
                                        ...
                                        disabled={ related_documents.length === 0 }
                        ...
                        <Grid item>
                            <Button
                                ...
                                variant="contained"
                                onClick={ handleReset }
                                disabled={ default_related_documents === related_documents && default_unrelated_documents === unrelated_documents }
                                aria-label="reset"
                            >
                                リセットする
                            </Button>
                        ...
                        <Grid item>
                            <form action={ `/links/question/` + props.id } method="POST" id="link">
                            ...
                            <Grid container spacing={2} justifyContent="center" alignItems="center">
                                ...
                                <Grid item>
                                    <Button
                                        ...
                                        size="small"
                                        onClick={ handleAllUp }
                                        disabled={ unrelated_documents.length === 0 }
                ...
                <Grid item sx={{ width: "100%", marginBottom: 5 }}>{customList(unrelated_documents, "down")}</Grid>
            </Grid>
        </Box>
    );
}
