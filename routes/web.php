...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::post('/questions/{question}', 'QuestionController@publicShow'); // 質問詳細画面閲覧情報記録
    ...
    Route::group(['middleware' => ['administrator']], function () {
        ...
        Route::post('/links/question/{question}', 'LinkController@linkDocumentsFromQuestion'); // 新規作成実行(記事：質問＝多：1)
